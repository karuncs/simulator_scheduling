...
public class SystemBuilder_old {
	
	/**
	 * The system can build here..
	 * based on the given constants the system can build 
	 * 
	 */
	...
	public class SystemBuilder2 {
		...
		public SystemBuilder2(String topology) {
